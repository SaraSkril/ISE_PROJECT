...
public class ReflectionRefractionTests {
    ...
    public void myCoolTest() {
        ...
        Color a = new Color(178,146,72);
        Color b = new Color(235,112,153);
        Color c= new Color(112,235,157);
        Color d= new Color(75,205,123);
        scene.addGeometries( //
                new Triangle(Color.BLACK, new Material(0.5, 0.5, 60), //
                        new Point3D(-70, 70, 60), new Point3D(70, 70, 50), new Point3D(30, -30, 70)), //
                new Sphere( new Color(java.awt.Color.GREEN), new Material(0.5,0.5,70,0.7,0.3),15,
                        new Point3D(3,-3,7)),
                new Sphere( new Color(java.awt.Color.CYAN), new Material(0,0,110,0,0),5,
                        new Point3D(-7,7,3)),
        ...
        ImageWriter imageWriter = new ImageWriter("Whateverwewant", 200, 200, 600, 600);
        Render render = new Render(imageWriter, scene);
