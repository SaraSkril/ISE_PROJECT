   ...
   /** @Test
    ...
    public void findIntersectionsTest() {
      Sphere sphere = new Sphere(1d, new Point3D(1, 0, 0));
        ...
        assertEquals("Sphere behind Ray",null,sphere.findIntersections(new Ray(new Point3D(2, 1, 0), new Vector(3, 1, 0))));
        ...
        assertEquals("Ray from sphere outside",null,sphere.findIntersections(new Ray(new Point3D(2, 0, 0), new Vector(1, 1, 0))));
        ...
        assertEquals("Line through O, ray from sphere outside",null,sphere.findIntersections(new Ray(new Point3D(1, 1, 0), new Vector(0, 1, 0)))
                );

        // TC18: Ray starts after sphere (0 points)
        assertEquals("Line through O, ray outside sphere",null,sphere.findIntersections(new Ray(new Point3D(1, 2, 0), new Vector(0, 1, 0)))
                );
        ...
        // center line
        assertEquals("Ray orthogonal to ray head -> O line",null,sphere.findIntersections(new Ray(new Point3D(-1, 0, 0), new Vector(0, 0, 1)))
                );
